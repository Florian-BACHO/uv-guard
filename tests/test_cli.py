...
def test_add_standard_package(mock_uv, mock_project_manager, mock_guardrails):
...
def test_add_hub_uri(mock_uv, mock_project_manager, mock_guardrails):
...
def test_add_mixed_args(mock_uv, mock_project_manager, mock_guardrails):
...
def test_remove_command(mock_uv, mock_project_manager, mock_guardrails):
...
def test_sync_command(mock_uv, mock_project_manager, mock_guardrails):
...
def test_sync_pass_through_args(mock_uv, mock_project_manager, mock_guardrails):
